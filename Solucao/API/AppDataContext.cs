...
public class AppDataContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlite("Data Source=NomeDoBanco.db");
    }

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categoria>().HasData(
            new Categoria { CategoriaId = "bfe4e7dc-81e4-4e47-a67b-d4fbf3e124bd", 
            Nome = "Trabalho", 
        ...
        modelBuilder.Entity<Tarefa>().HasData(
            new Tarefa { TarefaId = "6a8b3e4d-5e4e-4f7e-bdc9-9181e456ad0e", 
            Titulo = "Concluir relatório", Descricao = "Terminar relatório para reunião",
             CriadoEm = DateTime.Now.AddDays(7), 
             CategoriaId = "bfe4e7dc-81e4-4e47-a67b-d4fbf3e124bd", Status = "Não iniciada" },
